...
#Screen grid is 28 rows x 33 columns, this leaves a margin of 5 on each side of horizontal and vertical Axis.
#The 2 top rows will be used to display the score and other game data.
